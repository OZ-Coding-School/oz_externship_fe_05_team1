...
export default function AdminLoginPage() {
  ...
  return (
    <section className="flex h-screen bg-primary-500/3">
      <div className="flex h-full w-1/2 flex-col items-center justify-center bg-white">
        ...
        <p className="mb-4 text-sm">
          ...
          <span className="text-whilte">을 통해 로그인을 진행해주세요.</span>
        </p>
        <BaseInput
        ...
        />
        <Button className="h-12 w-82" variant="primary" onClick={handleSubmit}>
          로그인
        </Button>
      </div>
      <div className="w-1/2" />
